...
class GradientBorderView: UIView {
    ...
    private func customize() {
        ...
        gradientLayer.colors = [ColorBrand.brandgradientPink.cgColor, ColorBrand.brandgradientBlue.cgColor,ColorBrand.brandgradientPink.cgColor, ColorBrand.brandgradientBlue.cgColor]
...
class GradientBorderStackView: UIStackView {
