...
class CompititorReplyPromoterEventCell: UITableViewCell {
    ...
    func setup(_ message: MessageModel?) {
        ...
        guard let model = Mapper<PromoterEventsModel>().map(JSONString: _msg.replyTo?.data ?? "") else { return }
...
extension CompititorReplyPromoterEventCell: PlayerDelegate {
