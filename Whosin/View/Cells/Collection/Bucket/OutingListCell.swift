...
class OutingListCell: UITableViewCell {
    ...
    func setupData(_ model: OutingListModel) {
        ...
        _venueImage.loadWebImage(model.venue?.logo ?? kEmptyString)
...
extension OutingListCell: CustomCollectionViewDelegate {
...
extension OutingListCell: UpdateUsersDelegate {
