...
// --------------------------------------
// MARK: Bank deteail EndPoint
// --------------------------------------

private let kUpdateBankDetailEndPoint = "user/tour-guide/update-bank-detail"
private let kGetBankDetailEndPoint = "user/tour-guide/get-bank-detail"
...
class WhosinServices: BaseApiService {
    ...
    public class func updateBankDetail(params: [String: Any], callback: ObjectResult<ContainerModel<BankModel>>? = nil) {
        let url = URLMANAGER.baseUrl(endPoint: kUpdateBankDetailEndPoint)
        let request = POST(url, parameters: params)
        _ = _service?.request(request, model: ContainerModel<BankModel>.self, callback: callback)
    }
    
    public class func getBankDetail(callback: ObjectResult<ContainerModel<BankModel>>? = nil) {
        let url = URLMANAGER.baseUrl(endPoint: kGetBankDetailEndPoint)
        let request = POST(url, parameters: nil)
        _ = _service?.request(request, model: ContainerModel<BankModel>.self, callback: callback)
    }
